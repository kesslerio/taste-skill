...
## Naming (for composition)

- Repository folder name: `taste-skill`
- Skill frontmatter name (in `SKILL.md`): `design-taste-frontend`

Keep the `SKILL.md` frontmatter name unchanged for compatibility with composed skills (e.g. `frontend-design-pro`) that reference `design-taste-frontend` by name.
